...
class PDTTest(TestCase):
    urls = "django_moip.html.pdt.tests.test_urls"
    ...
    def setUp(self):
        ...
        # monkey patch the MoipPDT._postback function
        self.dpppdt = DummyMoipPDT()
        self.dpppdt.update_with_get_params(self.get_params)
        MoipPDT._postback = self.dpppdt._postback
